<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Admin_BannerControl.ascx.cs" Inherits="ShipBooking.Controls.Layer.Admin_BannerControl" %>
<style type="text/css">
    .banner_style
    {
        width: 100%;
    ...
    <tr>
        ...
        <td class="banner_headpicture_style">
            <asp:Image ID="Image1" runat="server" ImageUrl="~/Images/admin.jpg" 
                Width="405px" Height="62px" style="margin-left: 50px" />
        </td>
    </tr>
</table>
